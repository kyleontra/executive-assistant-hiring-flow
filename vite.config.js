...
module.exports = defineConfig({
  ...
  plugins: [{
    ...
    writeBundle() {
      ['script.js', 'auth-client.js', 'platform-client.js', 'verification.js', 'id-verification.js', 'candidate-signup.js', 'email-confirmed.js', 'candidate-resume.js', 'candidate-experience.js', 'candidate-profile.js', 'application-questions.js', 'candidate-login.js', 'candidate-dashboard.js', 'scheduler-settings.js', 'schedule-interview.js', 'admin-review.js', 'posted-jobs.js'].forEach(file => {
